...
public class HeroPage {
	...
	static ActionHelper help=new ActionHelper();
	static ValidaterHelper validate=new ValidaterHelper();
	public static void validateHeropPage(WebDriver driver,Properties prop,String[] proddata,int a) throws InterruptedException, ParseException{
